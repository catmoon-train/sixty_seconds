...
public class CanyuesaHorseshoeItem extends Item {
    ...
    public CanyuesaHorseshoeItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        CanyuesaHorseEntity horse = new CanyuesaHorseEntity(ModEntities.HOLD_CANYUESA_HORSE.get(), level);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.sixty_seconds.horseshoe_canyuesa.description"));
    }
}
