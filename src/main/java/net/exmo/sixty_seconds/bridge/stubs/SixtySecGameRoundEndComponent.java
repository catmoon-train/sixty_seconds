...
public class SixtySecGameRoundEndComponent {
    public static final ComponentKey<SixtySecGameRoundEndComponent> KEY = ComponentRegistry.getOrCreate(
            SixtySeconds.id("round_end"), SixtySecGameRoundEndComponent.class);
    private final Level world;
    private GameUtils.WinStatus winStatus = GameUtils.WinStatus.NONE;
    public SixtySecGameRoundEndComponent(Level world) { this.world = world; }
