...
public class SuperPigHorseshoeItem extends Item {
    ...
    public SuperPigHorseshoeItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        SuperPigHorseEntity horse = new SuperPigHorseEntity(ModEntities.HOLD_SUPER_PIG_HORSE.get(), level);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.sixty_seconds.horseshoe_superpig.description"));
    }
}
