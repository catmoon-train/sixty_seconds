...
public class RainbowHorseshoeItem extends Item {
    ...
    public RainbowHorseshoeItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        RainbowHorseEntity horse = new RainbowHorseEntity(ModEntities.HOLD_RAINBOW_HORSE.get(), level);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.sixty_seconds.horseshoe_rainbow.description"));
    }
}
