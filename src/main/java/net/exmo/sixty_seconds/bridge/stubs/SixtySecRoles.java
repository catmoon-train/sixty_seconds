...
public final class SixtySecRoles {
    public static final Map<ResourceLocation, SixtySecRole> ROLES = new HashMap<>();
    ...
    static {
        for (ResourceLocation id : List.of(
            ...
            ROLES.put(id, new SixtySecRole(id, Component.translatable("role." + id.getNamespace() + "." + id.getPath())));
        }
    }

    private SixtySecRoles() {
    }
}
