...
public record SixtySecWritableBookContent(List<Filterable<String>> pages)
        implements BookContent<String, WritableBookContent> {
    public static final SixtySecWritableBookContent EMPTY = new SixtySecWritableBookContent(List.of());
    ...
    public static final Codec<SixtySecWritableBookContent> CODEC;
    public static final StreamCodec<ByteBuf, SixtySecWritableBookContent> STREAM_CODEC;

    public SixtySecWritableBookContent {
    ...
    static {
        ...
        CODEC = RecordCodecBuilder.create((instance) -> instance
                .group(PAGES_CODEC.optionalFieldOf("pages", List.of()).forGetter(SixtySecWritableBookContent::pages))
                .apply(instance, SixtySecWritableBookContent::new));
        STREAM_CODEC = Filterable.streamCodec(ByteBufCodecs.stringUtf8(PAGE_EDIT_LENGTH))
                .apply(ByteBufCodecs.list(MAX_PAGES))
                .map(SixtySecWritableBookContent::new, SixtySecWritableBookContent::pages);
    }
}
